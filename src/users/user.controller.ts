...
export class UserController {
    ...
    @ApiOperation({
        ...
        description: 'Update the user\'s current location for geolocation-based features.'
    })
    ...
    @ApiQuery({ name: 'latitude', description: 'User latitude', example: 40.7128 })
    @ApiQuery({ name: 'longitude', description: 'User longitude', example: -74.0060 })
    @ApiQuery({ name: 'radius', description: 'Search radius in km', example: 50, required: false })
    @ApiResponse({
        status: 200,
    ...
    @ApiQuery({ name: 'longitude', description: 'User longitude', required: false })

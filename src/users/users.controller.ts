...
export class UsersController {
  ...
  @ApiOperation({
    ...
    description:
      "Update the authenticated user's profile information. Sends email notification.",
  })
  @ApiResponse({
    status: 200,
  ...
  @ApiOperation({
    ...
    description:
      "Change the authenticated user's password. Invalidates all sessions and sends email notification.",
  })
  @ApiResponse({
    status: 200,
  ...
  @ApiOperation({
    ...
    description:
      'Soft delete any user account. Requires ADMIN role. Sends confirmation email.',
  })
  @ApiParam({
    name: 'id',
    description: 'User unique identifier',
  ...
  @ApiOperation({
    ...
    description:
      "Update a user's role. Requires ADMIN role. Sends email notification.",
  })
  @ApiParam({
    name: 'id',
    description: 'User unique identifier',

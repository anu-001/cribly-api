...
export class ListingController {
  ...
  @ApiOperation({
    ...
    description:
      'Create a new property listing with location, details, and images.',
  })
  ...
  @ApiOperation({
    ...
    description:
      'Advanced property search with location-based filtering, sorting, and comprehensive filters.',
  })
  @ApiQuery({
    name: 'search',
    description: 'Search across title, description, and address',
    required: false,
  })
  @ApiQuery({
    name: 'propertyType',
    description: 'Property type filter',
    enum: ['HOUSE', 'APARTMENT', 'CONDO', 'TOWNHOUSE', 'STUDIO', 'ROOM'],
    required: false,
  })
  @ApiQuery({
    name: 'minPrice',
  ...
  @ApiQuery({
    name: 'province',
    description: 'Province/State filter',
    required: false,
  })
  ...
  @ApiQuery({
    ...
    enum: ['createdAt', 'price', 'distance', 'bedrooms', 'bathrooms'],
    required: false,
  })
  @ApiQuery({
    name: 'sortOrder',
  ...
  @ApiOperation({
    ...
    description:
      'Retrieve detailed information about a specific property listing.',
  })
  ...
  @ApiOperation({
    ...
    description:
      'Update an existing property listing. Only the listing owner can update their listings.',
  })
  ...
  @ApiOperation({
    ...
    description:
      'Delete a property listing permanently. Only the listing owner can delete their listings.',
  })
  @ApiParam({ name: 'id', description: 'Listing ID', type: 'string' })
  @ApiResponse({
    status: 200,

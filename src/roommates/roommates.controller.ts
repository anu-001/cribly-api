...
export class RoommatesController {
    ...
    @ApiOperation({
        ...
        description: 'Calculate compatibility score between authenticated user and target profile',
    })
    @ApiParam({
        name: 'profileId',
    ...
    @ApiOperation({
        ...
        description: 'Get personalized roommate recommendations based on compatibility',
    })
    @ApiQuery({
        name: 'limit',
        required: false,

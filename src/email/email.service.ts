...
export class EmailService {
  ...
  async sendWelcomeEmail(email: string, name: string): Promise<boolean> {
    ...
    return this.sendEmail({
      to: email,
      subject:
        '🎉 Welcome to Cribly - Your Roommate & Property Matching Platform',
      html,
    });
  }
  ...
  async sendConnectionRequestEmail(
    ...
    const html = this.getConnectionRequestEmailTemplate(
      name,
      requesterName,
      connectionType,
    );
  ...
  async sendNewMessageEmail(
    ...
    const html = this.getNewMessageEmailTemplate(
      name,
      senderName,
      messagePreview,
    );
  ...
  async sendPropertyInquiryEmail(
    ...
    const html = this.getPropertyInquiryEmailTemplate(
      agentName,
      inquirerName,
      propertyTitle,
    );
  ...
  private getConnectionRequestEmailTemplate(
    name: string,
    requesterName: string,
    connectionType: string,
  ): string {
  ...
  private getConnectionAcceptedEmailTemplate(
    name: string,
    accepterName: string,
  ): string {
    const content = `
  ...
  private getNewMessageEmailTemplate(
    name: string,
    senderName: string,
    messagePreview: string,
  ): string {
  ...
  private getPropertyInquiryEmailTemplate(
    agentName: string,
    inquirerName: string,
    propertyTitle: string,
  ): string {
  ...
  async sendVerificationFailureEmail(
    ...
    const html = this.getVerificationFailureTemplate(
      name,
      reason,
      remainingAttempts,
    );
